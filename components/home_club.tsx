    ...
    <>
      <Zoom>
        <div className="container mx-auto mt-10 p-5">
          ...
          {/* code for line 3 */}
          <div className="flex gap-4 flex-row align-middle items-center justify-center my-6">
          {/* <div className="w-1/6 p-10 bg-white rounded-lg shadow-lg h-[150px] transform transition-transform hover:scale-110"></div> */}
          <div className="w-1/4 p-10 bg-white rounded-lg shadow-lg h-[300px] transform transition-transform hover:scale-110"></div>
          <div className="w-1/4 p-10 bg-white rounded-lg shadow-lg h-[300px] transform transition-transform hover:scale-110"></div>
          <div className="w-1/4 p-10 bg-white rounded-lg shadow-lg h-[300px] transform transition-transform hover:scale-110"></div>
            <div className="w-1/4 p-10 bg-white rounded-lg shadow-lg h-[300px] transform transition-transform hover:scale-110"></div>
