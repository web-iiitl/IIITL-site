      ...
      <div className="my-10 grid grid-flow-row grid-cols-1  gap-x-20 gap-y-10   lg:grid-cols-2 ">
        ...
        <Zoom>
          ...
          <div className="  p-12 border-t-bluel border-t-[7px]  rounded-sm   shadow-xl">
            ...
            <a
            href="/news"
            className="group mt-10 relative inline-flex items-center justify-center p-3 px-6 py-2 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-blue-300 rounded-full shadow-md"
          >
            <span className="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 -translate-x-full bg-blue-500 group-hover:translate-x-0 ease">
              <svg
                className="w-6 h-6"
        ...
        <Zoom>
          ...
          <div className="  p-10 border-t-bluel border-t-[7px]  rounded-sm   shadow-xl">
            <div className="p-2 text-white absolute top-[-15px] left-2 rounded-full bg-bluel inline-block">
            ...
            <h4 className="text-bluel font-semibold">Announcements</h4>
            <div>
               {
